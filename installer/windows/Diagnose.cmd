@echo off
REM ===========================================================================
REM  AI Auto Editor Pro - Diagnose
REM
...
REM ===========================================================================
title AI Auto Editor Pro - Diagnose
setlocal
...
powershell.exe -NoProfile -NoLogo -ExecutionPolicy Bypass -File "%HERE%\Setup.ps1" -Action Doctor -InstallRoot "%HERE%"
set "RC=%ERRORLEVEL%"
